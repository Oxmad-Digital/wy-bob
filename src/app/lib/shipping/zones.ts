...
// dans shipping/countries.ts (mêmes pays) et avec POSTAL_CODE_PATTERNS dans
...
export const COUNTRY_SHIPPING: Record<string, CountryShipping> = {
  ...
  AF: { product: "express", zone: 7, delayDays: 5, relay: null },
  ...
  BY: { product: "express", zone: 4, delayDays: 2, relay: null },
  ...
  HT: { product: "express", zone: 5, delayDays: 2, relay: null },
  ...
  IR: { product: "express", zone: 6, delayDays: 3, relay: null },
  ...
  KI: { product: "express", zone: 7, delayDays: 5, relay: null },
  ...
  LY: { product: "express", zone: 6, delayDays: 4, relay: null },
  ...
  NR: { product: "express", zone: 7, delayDays: 6, relay: null },
  ...
  RU: { product: "express", zone: 4, delayDays: 3, relay: null },
  RW: { product: "express", zone: 6, delayDays: 3, relay: null },
  CF: { product: "express", zone: 6, delayDays: 4, relay: null },
  ...
  SO: { product: "express", zone: 6, delayDays: 4, relay: null },
  SD: { product: "express", zone: 6, delayDays: 4, relay: null },
  ...
  SY: { product: "express", zone: 6, delayDays: 2, relay: null },
  ...
  TV: { product: "express", zone: 7, delayDays: 6, relay: null },
  UA: { product: "express", zone: 4, delayDays: 2, relay: null },
  ...
  YE: { product: "express", zone: 6, delayDays: 3, relay: null },
